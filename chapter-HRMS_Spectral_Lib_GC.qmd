---
Title: Tutorial GC-HRMS Library
...
knitr::include_graphics("files/speclib/combineMSP.png", dpi = 100)
...
knitr::include_graphics("files/speclib/MSDIAL_startproject.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_choosefiles.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_peakdetection.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_MS1Dec.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_identification.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_filtering.png", dpi = 100)
```
...
[ADD INFO ABOUT MS-FINDER PARAMETERS]{style="color: red;"}
