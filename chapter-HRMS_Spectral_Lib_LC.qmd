---
Title: Tutorial LC-HRMS Library
...
[REWRITE SECTION TO ONLY USE DDA OR RUN BOTH DDA AND DIA?]{style="color: red;"}

[THIS SECTION IS INCOMPLETE AND SOME TEXT AND FIGURES ARE COPIED FROM GC TUTORIAL. NEED UPDATE!]{style="color: red;"}

[UNIFI SCIENTIFIC LIBRARY: https://support.waters.com/KB_Inf/UNIFI/WKB190999_How_to_build_and_manage_a_scientific_library_in_UNIFI]{style="color: red;"}
...
knitr::include_graphics("files/speclib/LC_MSDIAL_choosefiles.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/LC_MSDIAL_peakdetection.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/LC_MSDIAL_MS2Dec.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_7.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_8.png", dpi = 100)
```
...
knitr::include_graphics("files/speclib/MSDIAL_9.png", dpi = 100)
```
...
[NEED TO UPDATE TO LC msp]{style="color: red;"}

```{r LCmspfile, echo=FALSE, fig.cap= "Example of msp file"}

# msp_table <- readLines("files/speclib/MTM00029.txt")
# 
# cat(msp_table, sep = "\n")
